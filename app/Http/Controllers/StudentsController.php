...
class StudentsController extends Controller
{
    ...
    {
        $classes = Classe::pluck('grade', 'id');

        // $classes = DB::select('select CONCAT(name, grade), id from classes');
    ...
    public function store(Request $request)
    {
        ...
        $clasa_studiu = Classe::where('id', $class_id)->first();
        if(isset($clasa_studiu))
        {
        $grade = $clasa_studiu->grade;
        $student->grade = $grade;
